              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="view/AdminLTE 2.4.2/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="view/AdminLTE 2.4.2/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                     <a href="<?php echo $helper->url("Usuarios","Actualiza"); ?>" class="btn btn-warning btn-block btn-exit-system"><i class='fa fa-power-off'></i> Perfil</a>
                </div>
                <div class="user-footer pull-right">
                   <a href="<?php echo $helper->url("Usuarios","cerrar_sesion"); ?>" class="btn btn-danger btn-block btn-exit-system"><i class='fa fa-power-off'></i> Salir</a>
                 </div>
              </li>
            </ul>
          </li>
